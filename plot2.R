plot2 <- function(filetype="png"){
        
        ## This function creates a plot over time of "Global Active Power" in 
        ## the specified bitmap format graphics devices "bmp", "jpeg", "png", 
        ## or "tiff". If nothing is specified, a "png" file will be generated.
        ...
        fun_call(filename = paste("plot2.",filetype, sep = ""), 
