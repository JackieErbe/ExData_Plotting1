plot3 <- function(filetype="png"){
        
        ## This function creates a plot over time that contains data collected
        ## on three different Energy Submeters in the specified bitmap format 
        ## graphics devices "bmp", "jpeg", "png", or "tiff". If nothing is 
        ## specified, a "png" file will be generated.
        ...
        fun_call(filename = paste("plot3.",filetype, sep = ""), 
